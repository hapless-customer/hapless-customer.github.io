...
title: Welcome
---
I built this site on GitHub Pages, using the minima Jekyll layout. I was inspired by other GitHub Pages I've seen, mostly belonging to projects or acade  mic users. Set up took about five minutes from the "not-having-an-account" step. Beyond the simplicity, GitHub Pages has another advantage: it looks impressive. 
